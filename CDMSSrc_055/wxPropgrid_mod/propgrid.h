...
// automatically should be added in future.
    ...
    */
	...
	/* CORSIX HACKS */
    inline const wxString& GetLabelDescription() const { return m_labelDescription; }
    /* END CORSIX HACKS */
    ...
    */
    ...
    inline void SetHelpString( const wxString& helpString /* CORSIX HACKS */, const wxString& help_caption = wxT("") /* END CORSIX HACKS */)
    {
        EnsureDataExt();
        m_dataExt->m_helpString = helpString;
		/* CORSIX HACKS */
		if(help_caption != wxT("")) m_labelDescription = help_caption;
		/* END CORSIX HACKS */
    }

    inline void SetLabel( const wxString& label ) { /* CORSIX HACKS */ m_labelDescription = /* END CORSIX HACKS */ m_label = label; }
...
#define wxPG_PROP_ID_GETPROPVAL_CALL_PROLOG_RETVAL(TYPENAME, DEFVAL) \
    ...
    */
    inline void SetPropertyHelpString( wxPGId id, const wxString& helpString /* CORSIX HACKS */, const wxString& help_caption = wxT("") /* END CORSIX HACKS */)
    {
        wxPG_PROP_ID_CALL_PROLOG()
        p->SetHelpString(helpString /* CORSIX HACKS */, help_caption /* END CORSIX HACKS */);
    }

    inline void SetPropertyHelpString( wxPGPropNameStr name, const wxString& helpString /* CORSIX HACKS */, const wxString& help_caption = wxT("") /* END CORSIX HACKS */)
    {
        wxPG_PROP_NAME_CALL_PROLOG()
        p->SetHelpString(helpString /* CORSIX HACKS */, help_caption /* END CORSIX HACKS */);
    }
