...
{ UNUSED(event);
	m_pOutFile->SetValue(wxFileSelector(AppStr(aesetup_outselect), wxT(""), m_pOutFile->GetValue(), wxT("dat"), AppStr(aesetup_filter), wxFD_SAVE | wxFD_OVERWRITE_PROMPT, TheConstruct));
}
