...
{
	m_pOutFile->SetValue(wxFileSelector(AppStr(sgapack_outselect), wxT(""), m_pOutFile->GetValue(), wxT("sga"), AppStr(sgapack_filter) , wxFD_SAVE | wxFD_OVERWRITE_PROMPT, TheConstruct));
