    ...
    : wxWindow(parent, id, pos, size)
{
	...
	if (iDonatePos == 1)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_LoadMod, AppStr(open_mod), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 2)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_LoadModDC, AppStr(open_moddc), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 3)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_LoadModSS, AppStr(open_modss), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 4)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_LoadModCoH, AppStr(open_modcoh), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 5)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_LoadSga, AppStr(open_sga), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 6)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		                   AppStr(donate_help)),
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(SBT(new wxButton(this, IDC_Help, AppStr(help_index), wxDefaultPosition, wxSize(150, -1)),
	...
	if (iDonatePos == 7)
		pTopSizer->Add(SBT(new wxBitmapButton(this, IDC_Donate, *m_pDonateBitmap, wxDefaultPosition, wxDefaultSize, 0),
		               ...
		               0, wxALL | wxALIGN_CENTER, 3);
	pTopSizer->Add(
	    SBT(new wxButton(this, IDC_Quit, AppStr(exit), wxDefaultPosition, wxSize(150, -1)), AppStr(exit_help)), 0,
