...
S(app_backuperror, "The file could not be backed up. In the unlikely event that the save operation corrupts the file, "
                   "a backup would be useful. If you wish to make a backup, do it manually now.")
S(app_backuperror_title, "Backup before Saving")
S(app_backupcannotrestore,
  "The backup of the file could not be restored. You will have to restore it manually\nBackup file: ")
...
S(rgdmacro_saveoutputfilter,
  "Text Files (*.txt)|*.txt|X/HTML Files (*.html;*.htm;*.xml)|*.html;*.htm;*.xml|All files (*.*)|*.*")
...
S(config_defolder, "/general/last_de_folder")
S(config_sashposition, "/general/sash_position")
S(config_appearance, "/general/appearance")
S(config_lsp_enabled, "/general/lsp_enabled")
S(config_preview_enabled, "/general/preview_enabled")
...
S(welcome_firstrun, "This is the first time you\'ve launched the application. It is strongly recommended to read the "
                    "documentation so that you know how to use the program, and any important changes since previous "
...
S(ucsedit_cannotsave_caption,
  "File could not be saved; check that the file is not read-only and that you have sufficient user rights.\nA backup "
  "of the original file has been created which will now be restored from")
...
/* Main Menu */
S(view_menu, "&View")
S(view_theme_system, "System Theme")
S(view_theme_system_help, "Follow the operating system theme")
S(view_theme_light, "Light Theme")
S(view_theme_light_help, "Use a light colour scheme")
S(view_theme_dark, "Dark Theme")
S(view_theme_dark_help, "Use a dark colour scheme")
S(view_lsp_enabled, "&Lua Language Server")
S(view_lsp_enabled_help, "Enable or disable the Lua language server for code intelligence")
S(view_preview_enabled, "&File Preview")
S(view_preview_enabled_help, "Enable or disable single-click file preview in the file tree")
...
S(open_sga_menu, "Open &SGA Archive\tCTRL+SHIFT+O")
S(open_sga_help, "Open a single SGA data archive")
S(open_moddc, "Load DoW:DC Mod")
S(open_moddc_menu, "Open &DoW:DC Mod")
...
S(open_modde, "Load DoW:DE Mod")
S(open_modde_menu, "Open DoW:&DE Mod\tCTRL+O")
S(open_modde_help, "Open an existing mod for Dawn of War: Definitive Edition")
S(open_modcoh, "Load CoH/OF Mod")
S(open_modcoh_menu, "Open &CoH/OF Mod")
...
S(ui_editor_menu, "&UI Editor")
S(ui_editor_help, "Relic\'s user interface editor")
S(play_menu, "&Play")
S(play_mod, "Play Mod")
S(play_mod_help, "Launch the game with the current mod loaded")
S(play_no_exe, "No game executable found in the mod folder")
...
S(help_index_menu, "&View Corsix Docs\tF1")
SE(help_index_help, wxString().Append(AppStr(app_title)).Append(wxT(" help pages")))
S(github_repo_menu, "&GitHub Repository")
S(github_repo_help, "CorsixModStudio on GitHub")
