  ...
  public:
	...
	*/
	...
	/*!
	    ...
	    hash ('#') MAY be used as a comment mark: it MAY be used in front or end of lines, whatever is behind it SHALL
	   ignored until the next line. <br> The format of the data contained within SHALL be: <br> [code]=[token], <br>
	        where [code] SHALL be the hexadecimal value within the RGD file prefixed using '0x' notation - the
	   hexadecimal numbers including the '0x' notation SHALL be case insensitive, <br> while [token] SHALL be the text
	   token represented by the [code]. <br> Whitespaces such as space and tab characters anywhere within the <code>
	   and/or <token> SHALL be ignored. <br> Blank lines SHALL be ignored. <br> The entries within the file MAY be
	   sorted, however it is NOT MANDATORY. <br> The file SHOULD NOT contain duplicate entries. <br> The file MAY
	   terminate with a blank line, however it is NOT MANDATORY. <br> There SHALL be no copyrights claimed, anyone SHALL
	   be able to obtain this file from any source, to freely modify according to personal needs. It SHALL be possible
	   to freely distribute this file in its original or modified form. <br>
	...
	*/
	...
	/*!
	    ...
	    \param[in] sFile The name of the file to save the custom key/value pairs to (if the file already exists then the
	   contents of it will be wiped)
