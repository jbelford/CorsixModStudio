...
CLuaFileCache::_tEntry::_tEntry(char *s, lua_State *L, bool b) : sName(s), L(L), pNext(nullptr), bUseful(b) {}
...
lua_State *CLuaFileCache::MakeState()
{
    ...
    m_pEntriesEnd = m_pEntriesEnd->pNext = new _tEntry(nullptr, L);
    return L;
}
