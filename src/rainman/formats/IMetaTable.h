  ...
  public:
      ...
      public:
        ...
        */
        ...
        /*!
            ...
            \return Returns a valid pointer or throws a CRainmanException. You need to delete this pointer when you are
           done using it.
        */
        ...
        /*!
            If the table has a Reference([[somefile]]) or Inherit([[somefile]]) then "somefile" is called the reference
           string The reference string can be a IMetaNode::DT_String, a IMetaNode::DT_WString, or there isn't one, it is
           IMetaNode::DT_NoData.
            \return Returns IMetaNode::DT_String, IMetaNode::DT_WString, IMetaNode::DT_NoData or throws a
           CRainmanException on error
        */
        virtual IMetaNode::eDataTypes VGetReferenceType() = 0;

        //! Set the data type of the reference string
        /*!
            \param[in] eType The data type to set the reference to (IMetaNode::DT_String, IMetaNode::DT_WString or
           IMetaNode::DT_NoData)
        ...
        */
        ...
        /*!
            ...
            \return A pointer to the newly created child, throws a CRainmanException on error. You need to delete this
    ...
    */
    ...
    /*!
        ...
        Child 2<br/>
        ...
        \return A fresh memory output stream which will be later deleted by the calling code. May throw a
       CRainmanException, but will otherwise return a valid pointer
    */
