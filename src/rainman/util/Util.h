...
/*!
    ...
    \param[out] sCustom If passed, the full path of the custom dictionary is strdup()ped here (If no custom dicitonary
   is found, nothing is done with this parameter)
