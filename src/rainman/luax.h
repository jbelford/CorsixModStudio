...
template <class T> T *luax_newuserdata(lua_State *L) { return (T *)lua_newuserdata(L, sizeof(T)); }

template <class T> T *lua51x_newuserdata(lua_State *L) { return (T *)lua51_newuserdata(L, sizeof(T)); }
