...
├── CMakeLuaInheritTree, CRefreshFilesTool
...
8 tools registered in `Construct.cpp` constructor:
...
7. `CMakeLuaInheritTree` — inheritance visualization
8. `CRefreshFilesTool` — file tree refresh
